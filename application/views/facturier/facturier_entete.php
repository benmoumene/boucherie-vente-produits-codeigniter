       ...
       <div class="navbar-header">
            ...
            <div class="collapse navbar-collapse" id="main_nav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a style="color: #000000 !important;" class="couleur-taille" href="<?= site_url('auth/deconnexion');?>" title="Se déconnecter par Ici !"><i class="fa fa-sign-out" style="color: #c31819;"></i> Déconnexion</a></li>
                </ul>
                <p class="navbar-text navbar-right">|</p>
                <p style="color: #000000 !important;" class="navbar-text navbar-right">Bienvenue <strong style="color: #000000 !important;"><a
                                href="<?= base_url('facturier/vue_edit_facturier') ?>"><?= $role_ut . " " . $nom_ut; ?></a></strong></p>
